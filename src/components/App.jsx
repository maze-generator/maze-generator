...
import { createPipedTextGraphic } from 'maze-visualizer'
import './App.css'
...
export default class App extends React.Component {
	...
	updateGraphic () {
		this.setState({graphic: createPipedTextGraphic(this.state.maze.graph)})
